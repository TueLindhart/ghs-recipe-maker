...
Given a list of ingredients in English, estimate the weights in kilograms for each ingredient.
Explain your reasoning for the estimation of weights and why you estimate some ingredients to be negligible.
...
Ingredients that weigh less than 50 grams or 0.050 kilograms should be referred to as 'negligible'.
